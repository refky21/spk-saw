...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength) {
            ...
            var input = $('<input type="text" class="' + search_init + sCSSClass + '" value="' + inputvalue + '" style=""/>');
            th.html(input);
            if (bIsNumber)
            ...
            if (bIsNumber && !oTable.fnSettings().oFeatures.bServerSide) {
                input.keyup(function () {
					...
					var val = this.value;
					delay(function(){
						oTable.fnFilter('^' + val, _fnColumnIndex(index), true, false);//Issue 37
						fnOnFiltered();
					}, 750 );
                ...
                input.keyup(function () {
					...
					//Check has the user entered at least iFilterLength new characters
						...
						if(typeof iLastFilterLength == "undefined")
							iLastFilterLength = 0;
						var iCurrentFilterLength = val.length;
					...
					delay(function(){
						oTable.fnFilter(val, _fnColumnIndex(index), regex, smart);//Issue 37
						fnOnFiltered();
					}, 750 );
                });
            }
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel) {
            ...
            var r = '<select class="search_init"><option value="" class="search_init">' + sLabel + '</option>';
            var j = 0;
        ...
        function fnCreateCheckbox(oTable, aData) {
            ...
            r += '<div id="' + checkToggleDiv + '" '
            	+ 'title="' + label + '" '
            	+ 'class="toggle-check"  style="width: ' + (divWidthToggle) + '%; " >'; //dialog div
