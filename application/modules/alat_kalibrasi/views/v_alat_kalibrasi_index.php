...
<div class="card">
    <div class="card-header text-right">
        <h4 class="card-title"><strong>Data Alat Kalibrasi</strong></h4>
    ...
    <form class="" method="POST" action="" id="frmFilter">
        <div class="row">
            ...
            <div class="form-group">
                <label>Nama Alat Kalibrasi:</label>
...
<div class="modal-content">
    <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Tambah <?= $template['title'];?></h4>
        <button type="button" class="close" data-dismiss="modal"> <span aria-hidden="true">&times;</span></button>
    </div>
    <form id="form" class="form-horizontal" method="POST" action="<?= site_url($module.'/add') ?>">
...
$(function() {
    ...
    var dt = $('#datatables_ajax').DataTable({
        ...
        "searching": false,
        "ajax" : {
            "url" : "<?php echo site_url($module . '/datatables_alatKalibrasi/') ?>",
            "type" : "POST",
            "data" : function(d) {
    ...
    $('#add-btn').on('click', function(e) {
        e.preventDefault();
            ...
            $('.modal-title').text('Tambah Alat Kalibrasi');
    ...
    var modalEdit = function(opt) {
        opt = opt || {};
        app.modaler({
            title: 'Ubah Data Alat Kalibrasi',
            url: opt.url,
            footerVisible: false,
    ...
    var modalDelete = function(opt) {
        app.modaler({
            ...
            title: '<i class="fa fa-warning"></i> Hapus Teknisi',
