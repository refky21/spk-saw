	...
	jQuery(function($) {
		$("#unitParent").select2();
							...
							<div class="form-group <?php echo (form_error('unitKode')) ? 'has-error' :''; ?>">
								...
								<div class="col-xs-12 col-sm-4">
									<span class="block input-icon input-icon-right">
										<input name="unitKode" id="unitKode" class="width-100" type="text" value="<?php echo (isset($_POST['unitKode'])) ? set_value('unitKode') : $data_unit->UnitKode;?>">
							...
							<div class="form-group <?php echo (form_error('unitNama')) ? 'has-error' :''; ?>">
								...
								<div class="col-xs-12 col-sm-4">
									<span class="block input-icon input-icon-right">
										<input name="unitNama" id="unitNama" class="width-100" type="text" value="<?php echo (isset($_POST['unitNama'])) ? set_value('unitNama') : $data_unit->UnitName;?>">	
