...
<div class="card box">
    <div class="card-header text-right">
        <h4 class="card-title"><strong>Data Framework</strong></h4>
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <select class="form-control" name="pemrograman" required>
                    <option>Pilih Bahasa Pemrograman</option>
                    <?php 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="framework" required>
...
$(function() {
    ...
    var modalDelete = function(opt) {
        app.modaler({
            ...
            title: '<i class="fa fa-warning"></i> Hapus Data ',
