    ...
    <form id="form" class="form-horizontal" method="POST" action="<?php echo site_url($module.'/add') ?>">
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control"  name="bahasaPemrograman">
...
$(function() {
    ...
    $('#add-btn').on('click', function(e) {
        e.preventDefault();
            ...
            $('.modal-title').text('Tambah Bahasa Pemrograman');
    ...
    var modalDelete = function(opt) {
        app.modaler({
            ...
            title: '<i class="fa fa-warning"></i> Hapus Data Bahasa Pem',
