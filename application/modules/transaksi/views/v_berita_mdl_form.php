    ...
    <div class="form-groups-attached">
            ...
            <div class="row">
                <div class="form-group col-4">
                    <label class="required">Nomor Seri</label>
                    <input class="form-control" type="text" required name="no_seri" value="<?= (isset($dtPmtAlat['NoSeri'])) ? $dtPmtAlat['NoSeri'] : '';?>">
                </div>
                <div class="form-group col-4">
                    <label >Merek</label>
                ...
                <div class="form-group col-4">
                    <label class="required">Tipe Alat</label>
                    <input class="form-control" type="text" required name="tipe_alat" value="<?= (isset($dtPmtAlat['Tipe'])) ? $dtPmtAlat['Tipe'] : '';?>">
                </div>
            </div>
