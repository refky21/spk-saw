...
<div class="px-5">
    ...
    <div class="form-group row">
        ...
        <div class="col-2">
            <input type="text" name="tgl" id="tgl-pmt" class="form-control" data-provide="datepicker" data-date-today-btn="linked" data-date-today-highlight="true" data-date-format="dd/mm/yyyy" value=""  readonly>
            <input type="hidden" id="tgl-pmt-real" name="tgl_pmt_real" value="">
        ...
        <div class="col-2">
            <div class="input-group mb-10">
                <div class="input-group-btn">
                    <div class="btn-group">
                    <input type="number" name="durasi_pengerjaan" id="durasi_pengerjaan" class="form-control" >
                    ...
                    <thead >
                        ...
                        <tbody>
                            <tr id="tmplListBarang" style="display: none;">
                                ...
                                <!-- <td>
                                    <input type="text" class="form-control" id="lokasi-alat"  name="lokasi_alat">
                                </td> -->
                                <td id="total">
...
$(function() {
    ...
    $('#btnKali').on('click', function(e) {
        e.preventDefault();
        var act_url = '<?php echo site_url('permintaan/Permintaan/detail/kalibrasi'); ?>';
        app.modaler({
