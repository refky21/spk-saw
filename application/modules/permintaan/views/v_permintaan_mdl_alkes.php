...
$(function() {
    ...
    $('#datatables-barang').on('click', '#btnPilih', function(e) {
        ...
        $tr.find('#lokasi-alat').attr('name', 'lokasi_alat[]');
        $tr.find('#jns-diskon').attr('name', 'jnsDiskon[]');
        $tr.find('#hrg-diskon').attr('name', 'hrg_diskon[]').val(0);
        $tr.find('#id-brg').attr('name', 'brg_id[]').val(id);
        $tr.find('#hrg-akhir').attr('name', 'hrg_up[]').val(harga);
